...
class WelcomeController extends Controller
{
    private function graph_top_users_fake_ics(Request $request)
    {
        ...
        $data_top_users = DB::select('select * from detectenv.get_top_users_which_shared_news_ics(?) order by rate_fake_news desc;', array($number_top_users));
    ...
    public function show(Request $request)
    {
        ...
        $json_top_users = $this->graph_top_users_fake_ics($request);
